...
*/
{
  ...
  val isSelfReplication = {
    ...
    val soldCount = SELF.R5[Long].get == OUTPUTS(0).R5[Long].get
    ...
    sameBlockLimit && soldCount && sameExchangeRate && sameProjectAddress && sameDevFee && sameProjectLink && sameScript
  }
  ...
  val isBuyTokens = {
    ...
    // Verify if the token sold counter is decreased in proportion of the tokens sold.
    val incrementSoldCounterCorrectly = {
      ...
      val counterIncrement = {
        ...
        val selfAlreadySoldCounter = SELF.R5[Long].get
        val outputAlreadySoldCounter = OUTPUTS(0).R5[Long].get
  ...
  val soldCounterRemainsConstant = SELF.R5[Long].get == OUTPUTS(0).R5[Long].get
  ...
  val isRefundTokens = {
    ...
    val canBeRefund = {
      ...
      val minimumNotReached = {
        val soldCounter = SELF.R5[Long].get
